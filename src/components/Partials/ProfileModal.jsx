                ...
                <div className="p-6 text-center">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="email"
                            id="email"
                            class="bg-white border border-black-500/75 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400"
